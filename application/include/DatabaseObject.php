<?
    ...
    abstract class DatabaseObject
    {
        ...
        //@TODO load payment for useerid and Payment_id
        ...
        public static function BuildMultiple($db, $class, $data,$idName="_id",$isFullObj=false)
        {
            $ret = array();
        ...
        public static function BuildMultipleOrderDetail($db, $class, $data,$idName="_id",$isFullObj=false)
        {
            $ret = array();
        ...
        public static function constTable(){
            return 'users';
        }

        public static function constId(){
            return 'user_id';
